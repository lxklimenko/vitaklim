...
Она носит яркий  объемный свитер оверсайз  фиолетового цвета ( код цвета #58439D ) из коллекции моды весна 2026 года и зеленую  юбку / карандаш (код цвета  #155B56) Форму телу придает стильный ремень  зеленого  цвета ( код цвета #155B56 ) на талии поверх свитера 
...
Стиль фотографии: яркая европейская модная редакция, вдохновленная Vogue
Париж, Селин, Сен-Лоран и Роу.
Визуальное настроение: элегантная весна  в Париже с кинематографической атмосферой и роскошным минимализмом.
Выражение: твердый, элегантный и утонченный, передающий уверенность и утонченную женственность. Формат 9:16`,
    image: { src: `${STORAGE_URL}2photo.webp`, width: 1024, height: 1024, aspect: "1:1" },
